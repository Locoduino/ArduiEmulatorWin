...
class Adafruit_SSD1306 : public Adafruit_GFX {
 public:
  // NEW CONSTRUCTORS -- recommended for new projects
   Adafruit_SSD1306(uint8_t w, uint8_t h, TwoWire* twi = &WireClass::WireInstance, int8_t rst_pin = -1,
     uint32_t clkDuring = 400000UL, uint32_t clkAfter = 100000UL) : Adafruit_GFX(w,h) {}
   Adafruit_SSD1306(uint8_t w, uint8_t h, int8_t mosi_pin, int8_t sclk_pin,
     int8_t dc_pin, int8_t rst_pin, int8_t cs_pin) : Adafruit_GFX(w, h) {}
  ...
  Adafruit_SSD1306(int8_t mosi_pin, int8_t sclk_pin, int8_t dc_pin,
    int8_t rst_pin, int8_t cs_pin) : Adafruit_GFX(0, 0) {}
  Adafruit_SSD1306(int8_t dc_pin, int8_t rst_pin, int8_t cs_pin) : Adafruit_GFX(0, 0) {}
  Adafruit_SSD1306(int8_t rst_pin = -1) : Adafruit_GFX(0, 0) {}

  ~Adafruit_SSD1306(void) {}

  boolean      begin(uint8_t switchvcc = SSD1306_SWITCHCAPVCC,
    uint8_t i2caddr = 0, boolean reset = true,
    boolean periphBegin = true) { return false; }
  void         display(void) {}
  void         clearDisplay(void) { this->fillScreen(0); }
...
//  void         stopscroll(void) {}
  ...
  boolean      getPixel(int16_t x, int16_t y) { return false; }
  uint8_t* getBuffer(void) { return NULL; }
